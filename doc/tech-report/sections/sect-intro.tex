...
% Therefore the broad objective of this effort can 
...
% A2A (Administration to Administration) relationships. 

% Under this view the implementation of new context-awareness expert systems 
...
% the Linked (Open) Data~\cite{Berners-Lee-2006,Heath_Bizer_2011} initiative  to make it possible the view and application of the 
% Semantic Web to create a large and distributed database on the Web. 
