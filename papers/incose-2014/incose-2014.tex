...
\institute{Department of Computer Science, Carlos III University of Madrid, \\ 28911, Madrid, Spain\\
  \email{{\{josemaria.alvarez,juan.llorens,manuela.alejandres\}@uc3m.es}}\\
\and The Reuse Company Inc., \\ , Oviedo, Spain.\\
...
environment for detecting values of Correctness, Consistency and Completeness 
...
s% \input{sections/sect-conclusions}
