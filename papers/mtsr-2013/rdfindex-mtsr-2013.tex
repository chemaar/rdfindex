...
% \begin{itemize}
%  \item The Linked Data~\cite{Berners-Lee-2006,Heath_Bizer_2011} initiative. The emerging Web of Data and 
%  the sheer mass of information now available make it possible the deployment of new added-value services and applications based on the reuse of existing 
%  vocabularies and datasets. This initiative seeks for the application of semantic web concepts to 
%  create a large and distributed database on the Web. In order to reach this major objective the publication 
%  of information and data under a common data model (RDF) and formats~\cite{rdf-syntax,turtle-syntax,n3-syntax,rdf-binario,rdf-json} with a specific formal 
...
%  contains $337$ datasets, with more than $25$ billion RDF triples and $395$ million links in different 
%  domains. Research works are focused in two main areas: 1) production/publishing~\cite{bizer07how} and 2) consumption of 
...
%  through SPARQL endpoints deployed on the top of RDF repositories such as OpenLink Virtuoso~\cite{Virtuoso} or OWLim~\cite{Kiryakov:2005:OPS:2113364.2113388}. 
%  Furthermore and with regards to the promotion of raw data to RDF, there is an increasing interest in the creation of methodologies, best practices/recipes~\cite{best-gld,linked-data-cookbook} and lifecycles~\cite{gld-lifecycle,lod2-stack}. In this sense, some 
...
%  different approaches such as sensors~\cite{Jeung:2010:EMM:1850003.1850235,ontology-search} and techniques 
%  such as distributed queries\cite{Hartig09executingsparql,Ankolekar07thetwo,sparqlOpt}, scalable reasoning process~\cite{Urbani2010WebPIE,HoganHarthPolleres2009,DBLP:conf/semweb/HoganPPD10}, 
%  annnotation of web pages~\cite{rdfa-primer} or  information retrieval~\cite{Pound} to name a few.
%  
% 
% 
%  
%  \item The underlying semantics. FIXME: owl, reasoning, etc.
%  
%  
%  \end{itemize}
