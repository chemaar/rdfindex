...
public class DatasetStructureTO {
	...
	public String toString() {
		return "DatasetStructureTO [label=" + label + ", element=" + element
				+ ", operator=" + operator + ", measure=" + measure
				+ ", partsOf=" + partsOf + ", dimensions=" + dimensions + "]";
	}
